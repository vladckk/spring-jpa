...
insert into movies(title, year) values('The Green Mile', 1999),
	('Forrest Gump', 1994), ('The Little Mermaid', 1994), ('Moonlight Kingdom', 2012),
...
insert into staff(fullname, position) values('Tom Hanks', 'actor'), ('Michael Clarke Duncan', 'actor'),
    ...
    ('Kara Hayward', 'actor');
insert into moviegenres(Genres_id, Movies_id) values(3, 1), (5, 1), (2, 2), (3, 2), (1, 3), (4, 3), (5, 3),
	(2, 4), (3, 4), (2, 5), (3, 5);
insert into moviestaff(Movies_id, Staff_id) values(1, 1), (1, 2), (1, 3), (1, 4), (2, 1), (2, 5), (2, 6), (3, 7),
	(3, 8), (3, 9), (1, 10), (2, 11), (3, 12), (4, 13), (4, 14), (4, 15), (4, 16), (4, 17), (5, 13), (5, 17),
    (5, 18), (5, 19);